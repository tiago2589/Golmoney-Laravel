...
<!-- Joga a coluna no centro da tela em 6 colunas AULA 15-->
<div id="event-create-container" class="col-md-6 offset-md-3">
    <h1>Crie o seu evento</h1>
    <!-- adiciona os campos no formulario via POST, AULA 15  -->
    <form action="/events" method="POST" enctype="multipart/form-data">
        <!-- enctype="multipart/form-data // Para fazer upload de imagens no fomulario AULA 17 --> 
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Desenvolvedores GM\Desktop\Golmoney\hdcevents\resources\views/events/create.blade.php ENDPATH**/ ?>